    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card-body">
             <form class="form" method="post">
              ...
              <div class="form-group">
                ...
                <textarea name="ncontent" class="form-control" rows="4"></textarea>
              </div>              
			  </form>
              </div>
        ...
        <div class="col-12">
          ...
          <button id="insert" type="button" onclick="insert()" class="btn btn-primary float-right">저장</button>
        </div>
      </div>
            </div>
            </div>
...
function insert(){
	...
	if($("[name=ncontent]").val()=="") {
		alert("내용을 입력하세요");
		return;
	}
	location.href="${path}/insertNotice.do?" + $("form").serialize();
}
function update(){
